...
<body>
    <div class="row ctr-container-header">
        ...
        <div class="container-btn col-3">
            <a href="login.php"><button type="button" class="btn btn-primary login-btn"><i class="bi bi-person-check-fill"></i>Login</button></a>
            <a href="register.php"><button type="button" class="btn btn-primary regis-btn"><i class="bi bi-person-plus-fill"></i>Register</button></a>
        </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark nav-justified">
        <div class="container-fluid">
            ...
            <form class="d-flex">
                <input class="form-control me-2 src-bar" style="margin:3px" type="search" placeholder="Search" aria-label="Search">
    ...
    <div class="row">
        ...
        <div class="col-7">
            <div class="card col-lg-11 border-light">
                ...
                <div class="card-body">
                    <p class="card-text main-card">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                </div>
            </div>
        ...
        <div class="col-3 color-white">
            <div class="card text-end col-lg-11 side-card">
                <div class="card-body">
                    <img src="bapak.jpg" class="card-img-top" alt="...">
